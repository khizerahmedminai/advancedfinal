...
const Navdata = () => {
  ...
  //AdvancedProgramming state data
  ...
  const [isOffercard, setIsOffercard] = useState(false);
  const [isOfferreport, setIsOfferreport] = useState(false);
  ...
  useEffect(() => {
    ...
    if (isOffercard !== 'Offercard') {
      setIsOffercard(false);
    }

    if (isOfferreport !== 'Offerreport') {
      setIsOfferreport(false);
    }
    ...
    if (isCurrencies !== 'Currencies') {
      setIsCurrencies(false);
    }

    if (iscurrentState !== 'Cost') {
      setIsCost(false);
    }
  ...
  const menuItems = [
    ...
    { id: 'Students', icon: 'bx bx-user', label: 'Students', link: '/list/students' },
    { id: 'Faculty', icon: 'bx bx-buildings', label: 'Faculty', link: '/list/Faculty' },
    { id: 'Employee', icon: 'bx bx-user', label: 'Employee', link: '/list/Employee' },
    { id: 'Courses', icon: 'bx bxs-book', label: 'Courses', link: '/list/Courses' },
    { id: 'Enrollments', icon: 'bx bx-log-in-circle', label: 'Enrollments', link: '/list/Enrollments' },
    { id: 'Departments', icon: 'bx bx-buildings', label: 'Departments', link: '/list/Departments' },
    { id: 'Buildings', icon: 'bx bx-buildings', label: 'Buildings', link: '/list/Buildings' },
    { id: 'Rooms', icon: 'bx bx-buildings', label: 'Rooms', link: '/list/Rooms' },
